                ...
                <div className="flex flex-col gap-4 items-center max-w-[360px] w-full">
                  <div className="bg-[#f9fafb] border border-[#e4e7ec] rounded-lg flex gap-0.5 items-center w-full px-0.5 py-0.5">
                    <button
                      ...
                      className={`flex flex-1 gap-2 h-9 items-center justify-center overflow-clip px-3 py-2 rounded-lg transition-all ${
                        activeTab === 'company_details'
                          ? 'bg-white border border-[#d0d5dd] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]'
                          : ''
                      }`}
                    >
                      <span className={`font-['Inter',sans-serif] font-semibold text-[14px] leading-[20px] whitespace-nowrap ${
                        activeTab === 'company_details' ? 'text-[#344054]' : 'text-[#667085]'
                      }`}>
                        Company Details
                      </span>
                    </button>
                    ...
                    >
                      <span className={`font-['Inter',sans-serif] font-semibold text-[14px] leading-[20px] whitespace-nowrap ${
                        activeTab === 'lead_details' ? 'text-[#344054]' : 'text-[#667085]'
                      }`}>
                        Lead Details
                      </span>
                    </button>
